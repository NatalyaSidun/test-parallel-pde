 ...
 * Author: developer05
 *
 * Created on December 3, 2012, 10:50 AM
 */
#include "stdio.h"
#include "omp.h"
...
int main() {
    ...
    printf("Type thermal conductivity coefficient= %lf", koeff_teploprov);
